      ...
      >
        ...
        <div className="bg-white dark:bg-dark-bgSecondary rounded-3xl shadow-elegant p-8 md:p-10 ornate-border">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label htmlFor="password" className="block text-sm font-accent text-ink-800 dark:text-dark-text">
                  Password
                </label>
                <Link
                  href="/auth/forgot-password"
                  className="text-sm text-rose-500 dark:text-dark-rose hover:text-rose-600 dark:hover:text-rose-400 font-body"
                >
                  Forgot?
                </Link>
              </div>
          ...
          <p className="text-center text-ink-700 dark:text-dark-textSecondary font-body">
            New to Parallel?{' '}
            <Link href="/auth/register" className="text-rose-500 dark:text-dark-rose hover:text-rose-600 dark:hover:text-rose-400 font-accent font-semibold">
              Start your story
            </Link>
          </p>
        </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-sm text-ink-600 dark:text-dark-textMuted font-body">
            ...
            <Link href="/auth/register" className="text-rose-500 dark:text-dark-rose hover:text-rose-600 dark:hover:text-rose-400 font-accent">
              Sign up free
            </Link>
          </p>
        </div>
